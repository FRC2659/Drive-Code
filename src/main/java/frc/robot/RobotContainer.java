...
public class RobotContainer {
    ...
    /* Subsystems */
    public static final SwerveSubsystem s_Swerve = new SwerveSubsystem();
    ...
    public Command getAutonomousCommand() {
        ...
        return mModes.chosenAuto(AutoModeSelector.returnAutoMode());//AutoModeSelector.returnAutoMode()
    }
}
